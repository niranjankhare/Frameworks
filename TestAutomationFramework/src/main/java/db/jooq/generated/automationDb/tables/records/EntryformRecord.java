...
public class EntryformRecord extends TableRecordImpl<EntryformRecord> implements Record4<String, String, String, Integer> {

    private static final long serialVersionUID = -838405196;
     ...
     */
    @Override
    public EntryformRecord value4(Integer value) {
     ...
     */
    @Override
    public EntryformRecord values(String value1, String value2, String value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EntryformRecord(String elementtype, String controlname, String controldescription, Integer locatorvalue) {
        super(Entryform.ENTRYFORM);
