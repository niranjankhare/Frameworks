...
public class PageObjectCodegen {
    ...
    public static void generateSource() throws JClassAlreadyExistsException, IOException {
        ...
        JDefinedClass classToBeCreated = codeModel._class("com.foo.Bar");
        JClass jc = codeModel.ref(TextField.class); 
        
        //Creating private fields in the class
        
        JFieldVar field1 = classToBeCreated.field(JMod.PRIVATE,jc, "foo");
                
                
 
        //The codeModel instance will have a list of Java primitives which can be
        //used to create a primitive field in the new class
        JFieldVar field2 = classToBeCreated.field(JMod.PRIVATE, codeModel.DOUBLE, "bar",JExpr.direct("new TextField()"));
//        field2.assign( );
