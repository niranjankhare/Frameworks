...
public class GuimapRecord extends UpdatableRecordImpl<GuimapRecord> implements Record4<Integer, String, String, String> {

    private static final long serialVersionUID = 1058634903;
     ...
     */
    @Override
    public GuimapRecord value2(String value) {
        setPagename(value);
        return this;
    }
     ...
     */
    @Override
    public GuimapRecord values(Integer value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GuimapRecord(Integer guimapid, String pagename, String controlname, String controldescription) {
        super(Guimap.GUIMAP);
